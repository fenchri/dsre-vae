...
def plot_pr(dataset):
    ...
    if dataset == 'nyt10':
        names = ['pcnnatt', 'jointnre', 'reside', 'intra-inter', 'distre', 'baseline', 'vae', 'vae_prior']
        color = ['#797979', '#8c613c', '#dc7ec0', '#d5bb67', '#6acc64', '#ee854a', '#4878d0', '#d65f5f']
        marker = ['d', 's', '^', '*', 'v', '<', '>', 'o']
        ...
        names = ['baseline', 'vae', 'vae_prior']
        color = ['#ee854a', '#4878d0', '#d65f5f']
        marker = ['<', '>', 'o']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', choices=['nyt10', 'nyt10_570k', 'wikidistant'])
